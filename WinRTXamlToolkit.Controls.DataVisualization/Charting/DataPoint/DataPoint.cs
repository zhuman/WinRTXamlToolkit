...
namespace WinRTXamlToolkit.Controls.DataVisualization.Charting
{
    ...
    public abstract partial class DataPoint : Control
    {
        ...
        #region public double/*IComparable*/ ActualDependentValue
        /// <summary>
        /// Gets or sets the actual dependent value displayed in the chart.
        /// </summary>
        public double/*IComparable*/ ActualDependentValue
        {
            get { return (double/*IComparable*/)GetValue(ActualDependentValueProperty); }
        ...
        public static readonly DependencyProperty ActualDependentValueProperty =
            DependencyProperty.Register(
                ...
                typeof(double/*IComparable*/),
                typeof(DataPoint),
                new PropertyMetadata(default(double), OnActualDependentValuePropertyChanged));
        ...
        {
            DataPoint source = (DataPoint)d;
            double/*IComparable*/ oldValue = (double/*IComparable*/)e.OldValue;
            double/*IComparable*/ newValue = (double/*IComparable*/)e.NewValue;
        ...
        #endregion public double/*IComparable*/ ActualDependentValue
        ...
        #region public double/*IComparable*/ DependentValue
        /// <summary>
        /// Gets or sets the dependent value of the Control.
        /// </summary>
        public double/*IComparable*/ DependentValue
        {
            get { return (double/*IComparable*/) GetValue(DependentValueProperty); }
        ...
        public static readonly DependencyProperty DependentValueProperty =
            DependencyProperty.Register(
                ...
                typeof(double/*IComparable*/),
                typeof(DataPoint),
                new PropertyMetadata(default(double), OnDependentValuePropertyChanged));
        ...
        public static readonly DependencyProperty ActualIndependentValueProperty =
            DependencyProperty.Register(
                ...
                typeof(object),
                typeof(DataPoint),
                new PropertyMetadata(null, OnActualIndependentValuePropertyChanged));
