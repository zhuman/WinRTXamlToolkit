...
namespace WinRTXamlToolkit.Controls.DataVisualization.Charting
{
    ...
    public partial class PieSeries : DataPointSeries, IResourceDictionaryDispenser, IRequireGlobalSeriesIndex
    {
        ...
        protected override void AddDataPoint(DataPoint dataPoint)
        {
            ...
            pieDataPoint.SetBinding(PieDataPoint.StyleProperty, new Binding { Path = new PropertyPath(PieDataPoint.ActualDataPointStyleName), Source = pieDataPoint });
            ...
            legendItem.SetBinding(LegendItem.StyleProperty, new Binding { Path = new PropertyPath(ActualLegendItemStyleName), Source = pieDataPoint });
