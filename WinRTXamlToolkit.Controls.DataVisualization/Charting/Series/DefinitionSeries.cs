...
namespace WinRTXamlToolkit.Controls.DataVisualization.Charting
{
    ...
    [ContentProperty(Name = "SeriesDefinitions")]
    ...
    public abstract class DefinitionSeries : Control, ISeries, IAxisListener, IRangeProvider, IValueMarginProvider, IDataProvider, ISeriesHost
    {
        ...
        public static readonly DependencyProperty DependentAxisProperty =
            DependencyProperty.Register("DependentAxis", typeof(IAxis), typeof(DefinitionSeries), new PropertyMetadata(null,OnDependentAxisChanged));
        ...
        public static readonly DependencyProperty IndependentAxisProperty =
            DependencyProperty.Register("IndependentAxis", typeof(IAxis), typeof(DefinitionSeries), new PropertyMetadata(null,OnIndependentAxisChanged));
        ...
        private void ItemContainerSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            IList<Object> removedItems = removedDataItems.Select(di => di.Value).ToArray();
            IList<Object> addedItems = addedDataItems.Select(di => di.Value).ToArray();
        ...
        protected override void OnApplyTemplate()
        {
            ...
            if (null != _itemContainer)
            {
                ...
                _itemContainer.SizeChanged += new SizeChangedEventHandler(ItemContainerSizeChanged);
                _itemContainer.SelectionChanged += new SelectionChangedEventHandler(ItemContainerSelectionChanged);
                _itemContainer.SetBinding(Selector.SelectedIndexProperty, new Binding() {Path=new PropertyPath("SelectedIndex"), Source = this, Mode = BindingMode.TwoWay });
                _itemContainer.SetBinding(Selector.SelectedItemProperty, new Binding(){Path=new PropertyPath("SelectedItem") , Source = this, Mode = BindingMode.TwoWay, Converter = new SelectedItemToDataItemConverter(DataItems) });
            }
        ...
        private void PrepareContainerForItem(DependencyObject element, object item)
        {
            ...
            dataPoint.SetBinding(DataPoint.StyleProperty, new Binding { Path = new PropertyPath("ActualDataPointStyle"), Source = dataItem.SeriesDefinition });
            ...
            Binding selectionEnabledBinding = new Binding(){Path=new PropertyPath("SelectionMode") , Source = this, Converter = new SelectionModeToSelectionEnabledConverter() };
        ...
        private void DataPointDependentValueChanged(object sender, RoutedPropertyChangedEventArgs<IComparable> e)
        {
            ...
            {
                dataPoint.ActualDependentValue = (double/*IComparable*/)e.NewValue;
            }
        }
