...
namespace WinRTXamlToolkit.Controls.DataVisualization.Charting
{
    ...
    public class SeriesDefinition : FrameworkElement, ISeries, IRequireGlobalSeriesIndex
    {
        ...
        public static readonly DependencyProperty ItemsSourceProperty =
            DependencyProperty.Register("ItemsSource", typeof(IEnumerable), typeof(SeriesDefinition), new PropertyMetadata(null,OnItemsSourceChanged));
        ...
        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register("Title", typeof(object), typeof(SeriesDefinition), new PropertyMetadata(null,OnTitleChanged));
        ...
        public static readonly DependencyProperty DataPointStyleProperty =
            DependencyProperty.Register(DataPointStyleName, typeof(Style), typeof(SeriesDefinition), new PropertyMetadata(null,OnDataPointStyleChanged));
        ...
        public static readonly DependencyProperty LegendItemStyleProperty =
            DependencyProperty.Register(LegendItemStyleName, typeof(Style), typeof(SeriesDefinition), new PropertyMetadata(null,OnLegendItemStyleChanged));
        ...
        public static readonly DependencyProperty DataShapeStyleProperty =
            DependencyProperty.Register(DataShapeStyleName, typeof(Style), typeof(SeriesDefinition), new PropertyMetadata(null,OnDataShapeStyleChanged));
        ...
        /// <summary>
        /// Gets or sets the EasingFunctionBase to use for data transitions.
        /// </summary>
        public EasingFunctionBase TransitionEasingFunction
        {
            get { return (EasingFunctionBase)GetValue(TransitionEasingFunctionProperty); }
        ...
        public static readonly DependencyProperty TransitionEasingFunctionProperty =
            DependencyProperty.Register("TransitionEasingFunction", typeof(EasingFunctionBase), typeof(SeriesDefinition), new PropertyMetadata(new QuadraticEase { EasingMode = EasingMode.EaseInOut }));
#else
        /// <summary>
        /// Gets or sets a placeholder for the TransitionEasingFunction dependency property.
        /// </summary>
        internal EasingFunctionBase TransitionEasingFunction { get; set; }
#endif
    }
}
