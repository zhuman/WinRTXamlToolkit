...
namespace WinRTXamlToolkit.Controls
{
    ...
    public partial class Calendar : Control
    {
        ...
        public static readonly DependencyProperty CalendarButtonStyleProperty =
            ...
            typeof(Style),
            typeof(Calendar),
            new PropertyMetadata(null, OnCalendarButtonStyleChanged));
        ...
        public static readonly DependencyProperty CalendarDayButtonStyleProperty =
            ...
            typeof(Style),
            typeof(Calendar),
            new PropertyMetadata(null, OnCalendarDayButtonStyleChanged));
        ...
        public static readonly DependencyProperty CalendarItemStyleProperty =
            ...
            typeof(Style),
            typeof(Calendar),
            new PropertyMetadata(null, OnCalendarItemStyleChanged));
        ...
        public static readonly DependencyProperty DisplayModeProperty =
            ...
            typeof(CalendarMode),
            typeof(Calendar),
            new PropertyMetadata(CalendarMode.Month, OnDisplayModePropertyChanged));
        ...
        public static readonly DependencyProperty SelectionModeProperty =
            ...
            typeof(Calendar),
            new PropertyMetadata(CalendarSelectionMode.SingleDate, OnSelectionModeChanged));
        ...
        /// </remarks>
        //TODO: See if a workaround is required here
        ...
        /// Gets or sets Inherited code: Requires comment.
        /// </summary>
        internal List<object> RemovedItems { get; set; }
        ...
        /// </para>
        /// </remarks>
        //TODO: See if a workaround is needed
        //[TypeConverter(typeof(DateTimeTypeConverter))]
        ...
        /// Inherited code: Requires comment.
        /// </summary>
        internal event EventHandler<PointerRoutedEventArgs> DayButtonMouseUp;
        ...
        /// </summary>
        /// <param name="e">Inherited code: Requires comment 1.</param>
        internal void OnDayButtonMouseUp(PointerRoutedEventArgs e)
        {
            EventHandler<PointerRoutedEventArgs> handler = DayButtonMouseUp;
            if (null != handler)
            {
                handler(this, e);
            }
        ...
        /// <param name="sender">Inherited code: Requires comment 1.</param>
        /// <param name="e">Inherited code: Requires comment 2.</param>
        private void Calendar_KeyUp(object sender, KeyRoutedEventArgs e)
        {
            if (!e.Handled && e.Key == VirtualKey.Shift)
            {
                ProcessShiftKeyUp();
            }
        }
