...
namespace WinRTXamlToolkit.Controls.Primitives
{
    ...
    public sealed class CalendarDayButton : Button
    {
        ...
        /// UIElement.
        /// </summary>
        public event EventHandler<PointerRoutedEventArgs> CalendarDayButtonMouseDown;
        ...
        /// capture).
        /// </summary>
        public event EventHandler<PointerRoutedEventArgs> CalendarDayButtonMouseUp;
        ...
        protected override void OnPointerPressed(PointerRoutedEventArgs e)
        {
            ...
            EventHandler<PointerRoutedEventArgs> handler = CalendarDayButtonMouseDown;
            if (null != handler)
            {
                handler(this, e);
            }
        ...
        protected override void OnPointerReleased(PointerRoutedEventArgs e)
        {
            ...
            EventHandler<PointerRoutedEventArgs> handler = CalendarDayButtonMouseUp;
            if (null != handler)
            {
                handler(this, e);
            }
