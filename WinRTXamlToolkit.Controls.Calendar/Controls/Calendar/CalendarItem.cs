    ...
    public sealed partial class CalendarItem : Control
    {
        ...
        internal Button NextButton
        {
            ...
            private set
            {
                ...
                if (_nextButton != null)
                {
                    ...
                    {
                        _nextButton.Content = Properties.Resources.Calendar_NextButtonName;
                    }
        ...
        internal Button PreviousButton
        {
            ...
            private set
            {
                ...
                if (_previousButton != null)
                {
                    ...
                    {
                        _previousButton.Content = Properties.Resources.Calendar_PreviousButtonName;
                    }
        ...
        internal Grid MonthView
        {
            ...
            private set
            {
                ...
                if (_monthView != null)
                {
                    _monthView.PointerExited += MonthView_PointerExited;
                }
            }
        }
        ...
        internal Grid YearView
        {
            ...
            private set
            {
                ...
                if (_yearView != null)
                {
                    _yearView.PointerExited += YearView_PointerExited;
                }
            }
        }
        ...
        /// Inherited code: Requires comment.
        /// </summary>
        private PointerRoutedEventArgs _downEventArg;

        /// <summary>
        /// Inherited code: Requires comment.
        /// </summary>
        private PointerRoutedEventArgs _downEventArgYearView;
        ...
        private void SetDayTitles()
        {
            for (int childIndex = 0; childIndex < Calendar.ColumnsPerMonth; childIndex++)
            {
                ...
                if (daytitle != null)
                {
                    ...
                    {
                        daytitle.DataContext =
                            DateTimeHelper.GetCurrentDateFormat().AbbreviatedDayNames[
                                (childIndex + (int) DateTimeHelper.GetCurrentDateFormat().FirstDayOfWeek)%
                                NumberOfDaysPerWeek];
                    }
                }
            }
            ...
            foreach (object child in YearView.Children)
            {
                ...
                if (Owner != null)
                {
                    ...
                    Debug.Assert(Owner.DisplayDateInternal != null,
                                 "The Owner Calendar's DisplayDateInternal should not be null!");
        ...
        private void SetMonthModeNextButton(DateTime firstDayOfMonth)
        {
            if (Owner != null && NextButton != null)
            {
                ...
                else
                {
                    ...
                    NextButton.IsEnabled = (DateTimeHelper.CompareDays(Owner.DisplayDateRangeEnd, firstDayOfNextMonth) >
                                            -1);
                }
            }
        }
        ...
        internal void Cell_PointerEntered(object sender, PointerRoutedEventArgs pointerRoutedEventArgs)
        {
            if (Owner != null)
            {
        ...
        /// <param name="sender">Inherited code: Requires comment 1.</param>
        /// <param name="e">Inherited code: Requires comment 2.</param>
        internal void Cell_MouseLeftButtonDown(object sender, PointerRoutedEventArgs e)
        {
            if (Owner != null)
            {
                if (!Owner.HasFocusInternal)
        ...
        /// <param name="sender">Inherited code: Requires comment 1.</param>
        /// <param name="e">Inherited code: Requires comment 2.</param>
        internal void Cell_PointerReleased(object sender, PointerRoutedEventArgs e)
        {
            if (Owner != null)
            {
                bool ctrl, shift;
        ...
        /// <param name="sender">Inherited code: Requires comment 1.</param>
        /// <param name="e">Inherited code: Requires comment 2.</param>
        private void Month_CalendarButtonMouseDown(object sender, PointerRoutedEventArgs e)
        {
        ...
        /// <param name="sender">Inherited code: Requires comment 1.</param>
        /// <param name="e">Inherited code: Requires comment 2.</param>
        internal void Month_CalendarButtonMouseUp(object sender, PointerRoutedEventArgs e)
        {
            ...
            if (Owner != null)
            {
                ...
                {
                    Debug.Assert(Owner.DisplayMode == CalendarMode.Decade,
        ...
        /// <param name="sender">Inherited code: Requires comment 1.</param>
        /// <param name="e">Inherited code: Requires comment 2.</param>
        private void Month_PointerEntered(object sender, PointerRoutedEventArgs pointerRoutedEventArgs)
        {
        ...
        /// <param name="sender">Inherited code: Requires comment 1.</param>
        /// <param name="e">Inherited code: Requires comment 2.</param>
        private void Month_PointerExited(object sender, PointerRoutedEventArgs pointerRoutedEventArgs)
        {
            if (_isMouseLeftButtonDownYearView)
            {
                CalendarButton b = sender as CalendarButton;
                ...
                {
                    b.SendPointerReleased(_downEventArgYearView);
                }
        ...
        /// <param name="sender">Inherited code: Requires comment 1.</param>
        /// <param name="e">Inherited code: Requires comment 2.</param>
        private void MonthView_PointerExited(object sender, PointerRoutedEventArgs pointerRoutedEventArgs)
        {
            if (_lastCalendarDayButton != null)
            {
                _lastCalendarDayButton.CapturePointer(pointerRoutedEventArgs.Pointer);
            }
        }
        ...
        /// <param name="sender">Inherited code: Requires comment 1.</param>
        /// <param name="e">Inherited code: Requires comment 2.</param>
        private void YearView_PointerExited(object sender, PointerRoutedEventArgs e)
        {
